...
class DashboardRuntimeConfig:
    ...
    store_universe_path: Path | None = None
...
def load_dashboard_runtime_config(
    ...
    *,
    ...
    return DashboardRuntimeConfig(
        ...
        store_universe_path=_config_path(payload.get("store_universe_path"), base),
...
def _synthetic_overrides() -> tuple[PrivateMetricCatalogOverride, ...]:
    ...
    metric_specs = {
        ...
        "weighted_shelf_price_vat": "Полочная цена",
        "weighted_input_price_vat": "Входная цена",
